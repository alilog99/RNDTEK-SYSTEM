...
//   sendMail() {
//     var link = 'mailto:info@rndhub.co?subject=Message from '
...
sendFeedback (templateId, message, fromName, fromEmail) {
  window.emailjs.send(
    ...
    .then(res => {
      this.setState({ formEmailSent: true,fromEmail:"",fromName:"",messageBody:"" })
    })
                ...
                <div class="container">
                  ...
                  <div class="row">
                    <div class="col-sm-12 col-lg-4">
                      <img class="address-logo" src={addressicon} alt="addressicon" align="center" />
                      <ScrollAnimation animateIn='fadeIn'
                        animateOut='fadeOut'>  <Fade top>  <p className="font">Address</p></Fade></ScrollAnimation>
                      <ScrollAnimation animateIn='fadeIn'
                        animateOut='fadeOut'>  <Fade top><p className="font2">
                          RNDKTEK Ltd. Kemp House 160 City Road, London EC1V 2NX 
                        </p></Fade></ScrollAnimation>
                    </div>
                    <div class="col-sm-12 col-lg-4">
                      <img class="phone-logo" src={phoneicon} alt="addressicon" align="center" />
                      <ScrollAnimation animateIn='fadeIn'
                        animateOut='fadeOut'>  <Fade top> <p className="font">Phone</p></Fade></ScrollAnimation>
                      <ScrollAnimation animateIn='fadeIn'
                        animateOut='fadeOut'>  <Fade top>  <p className="font2">(0044) 7958 670704</p></Fade></ScrollAnimation>
                    </div>
                    <div class="col-sm-12 col-lg-4">
                      <img class="email-logo" src={emailicon} alt="addressicon" align="center" />
                      <ScrollAnimation animateIn='fadeIn'
                        animateOut='fadeOut'>  <Fade top> <p className="font" >
                          Email
                    </p></Fade></ScrollAnimation>
                      <ScrollAnimation animateIn='fadeIn'
                        animateOut='fadeOut'>  <Fade top>   <p className="font2">info@rndtek.co.uk</p></Fade></ScrollAnimation>
                    </div>
                  </div>
                ...
                <div class="row no-gutters">
                  ...
                  <div class="col-sm-12 col-md-4 col-lg-4">
                    <div className="contact-woman" >
                      <div>
                        <ScrollAnimation animateIn='fadeIn'
                          animateOut='fadeOut'> <Fade right> <img src={womenpic} alt="women" style={{ height: "365px",width:'100%' }} /></Fade></ScrollAnimation></div>
                    </div>
                  </div>
                </div>
                  ...
                  <Fade left>
                    <div style={{ padding: '40px 20px' }}>
                      ...
                      <p style={{
                        ...
                        and create a custom solution that drives innovation and growth.
                      </p>
                      <div style={{
                        background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
                        borderRadius: '15px',
